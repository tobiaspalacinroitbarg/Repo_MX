...
#"org","itr","itr_ctrl_donat","itr_donat_otorgados","itr_gastos","itr_ing_donat_rec","itr_inv_finan","itr_nec_atend","itr_org_gob","itr_sect_benef","itr_transm_patr","rda","dir_sat"
# Lista de tablas
tablas:list[str] = ["dir_sat"]
